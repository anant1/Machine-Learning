...
data=pd.read_excel("/media/anant/New Volume/ML/Project1/DataSet/university data.xlsx")
...
###3_Univariate PDF, Using scipy.stats.norm.pdf()
...
###3_Multivariate PDF, using inbuilt function scipy.stats.multivariate_normal.pdf()
...
######3_Multivariate_PDF using implemented formula for Multivariate pdf
multiVar_log=0
